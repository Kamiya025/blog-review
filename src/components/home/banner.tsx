...
export const Banner = () => {
  return (
    <div className="relative h-[60vh] font-bold whitespace-pre contain-size uppercase group">
      <div
        className="rounded-3xl w-full p-32 bg-gradient-to-tr from-1% from-blue-500 bg-blend-soft-light 
      ...
      >
        <div className="flex-1 flex-col gap-3 hidden md:flex z-30 text-white">
          ...
          <div className="flex gap-3 items-center text-5xl !h-20 mb-5 border select-none shadow-md w-fit pr-4 duration-300 group-hover:pl-4 group-hover:pr-0 rounded-xl cursor-pointer">
            <div
              className="relative bg-yellow-500  group-hover:ease-in duration-500 p-4 
            ...
            <div
              className="relative 
                        group-hover:ease-out duration-500 group-hover:bg-yellow-500 
      ...
      <Image
        ...
        width={430}
        height={10}
        className="absolute bottom-0 right-0 md:-left-20 z-20 animate-[wiggle_1s_ease-in-out_infinite] object-cover"
      />
    </div>
  )
}
